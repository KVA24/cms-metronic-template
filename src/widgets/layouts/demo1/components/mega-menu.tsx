import { MENU_MEGA } from '@/shared/config/menu.config';
...
import { MegaMenuSubAccount } from '@/widgets/mega-menu/mega-menu-sub-account';
import { MegaMenuSubAuth } from '@/widgets/mega-menu/mega-menu-sub-auth';
import { MegaMenuSubNetwork } from '@/widgets/mega-menu/mega-menu-sub-network';
import { MegaMenuSubProfiles } from '@/widgets/mega-menu/mega-menu-sub-profiles';
import { MegaMenuSubStore } from '@/widgets/mega-menu/mega-menu-sub-store';
