...
export function AdminTenantAccountPage() {
  ...
  return (
    <Container className="space-y-6 py-6 lg:py-8">
      ...
      <AdminTenantAccountDialog tenantId={tenantId} mode={mode} account={selected} requiresFirstAdmin={accounts.data.requiresFirstAdmin} canEdit={accounts.data.canEdit} onModeChange={(next) => { setMode(next); if (!next) setSelected(null); }} />
