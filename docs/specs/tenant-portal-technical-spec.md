...
- [ ] T1–T4: TENANT login, recovery, permission seeds, routes and menus
...
- [ ] All four personas and all recovery states work with EN/VI UI.
- [ ] Tenant namespace, first-permitted route and menu/action guards match the approved matrix.
